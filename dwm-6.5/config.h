...
static const char *spcalc[] = {TERMINAL, "-n", "spcalc", "-f", "monospace:size=16", "-g", "50x20", "-e", "bc", "-lq", NULL };
static const char *network[] = {TERMINAL, "-n", "network", "-g", "50x20", "-e", "nmtui", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_u,      incrgaps,       {.i = -1 } }, { MODKEY,                       XK_i,      incrigaps,      {.i = +1 } },
